...
# parser.add_argument('db', type=str, nargs=1, help='CALIFA superFITS.')
# 
...
im = ax.imshow(K.fluxRatio__yx(6100, 6500, 4000, 4500), vmin=0.5, vmax=2.0, cmap='RdBu_r', label=r'Flux ratio ($F_{6300\AA} / F_{4250\AA})$')

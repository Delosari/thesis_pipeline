...
Ions_dict = OrderedDict()
Test = pn.Atom('O', 2)

Ions_dict['H1'] = pn.RecAtom('H', 1)
Ions_dict['He1'] = pn.RecAtom('He', 1)
Ions_dict['He2'] = pn.RecAtom('He', 2)
Ions_dict['O2'] = pn.Atom('O', 2)
Ions_dict['O3'] = pn.Atom('O', 3)
Ions_dict['N2'] = pn.Atom('N', 2)
Ions_dict['S2'] = pn.Atom('S', 2)
Ions_dict['S3'] = pn.Atom('S', 3)
Ions_dict['S4'] = pn.Atom('S', 4)
Ions_dict['Ar3'] = pn.Atom('Ar', 3)
Ions_dict['Ar4'] = pn.Atom('Ar', 4)

print '---------------------Ions considered--------------------------'
for ion in Ions_dict:
    print Ions_dict[ion].printSources()

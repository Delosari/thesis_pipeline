...
linformat_df    = pd.read_csv('/home/vital/git/Dazer/Dazer/dazer/bin/emlines_pyneb_optical_infrared.dz', names=['line_label', 'ion', 'lambda_theo', 'latex_format'], delim_whitespace=True)

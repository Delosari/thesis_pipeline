...
for i in range(len(catalogue_df.index)):
    ...
    subwave, subflux, lineHeight, LineExpLoc = Emission_Threshold(7319.0, wave, flux)
    
    #Establish current line
    dz.Current_Label    = 'O2_7319A'
    dz.Current_Ion      = 'O2'
    dz.Current_TheoLoc  = 7319.0
    selections          = array([7294.84,7310.1, 7315.35,7338.28, 7340.59,7365.31])

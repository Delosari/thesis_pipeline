...
'''
Run
python /home/vital/git/Thesis_Pipeline/Thesis_Pipeline/Spectra_Reduction/F4_Apall_extraction_Bg.py
'''
...
#Reference for the differnt types

#Loop through the arms
colors  = ['Red']
slit_minimum = float(dz.observation_dict['slit_minimum'][0])
...
for arm_color in colors:
    ...
    for i in range(len(objects)):
        ...
        if objects[i] in ['IZW18']:
            ...
            output_name                         = Files_Names[i][0:Files_Names[i].find('.')] + '_e_{}.fits'.format(dz.testing_extension)

...
with doc.create(Tabular(table_format)) as table:
    ...
    for i in range(len(file_names)):
        ...
        if valid_values[i] == True:
            entry_object_type = '{codename}'.format(codename = objects[i])
        else:
...
for i in range(len(frames_obj)):
    target_object = frames_obj[i]
    blue_file     = matched_frames['{codename}_{arm_color}_{calib_file}_bySeparation'.format(codename = target_object, arm_color = 'Blue', calib_file = 'flat')]
    red_file      = matched_frames['{codename}_{arm_color}_{calib_file}_bySeparation'.format(codename = target_object, arm_color = 'Red', calib_file = 'flat')]
    ...
    dz.observation_dict[target_object + '_flat'] = [blue_run, red_run]

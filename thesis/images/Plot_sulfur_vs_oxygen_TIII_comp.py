...
dz.data_plot(unumpy.nominal_values(TeOIII_array), unumpy.nominal_values(TeSIII_array), 'HII galaxies', markerstyle='o',  x_error=unumpy.std_devs(TeOIII_array),  y_error=unumpy.std_devs(TeSIII_array), color=dz.get_color(0))
dz.plot_text(unumpy.nominal_values(TeOIII_array), unumpy.nominal_values(TeSIII_array),  objects, fontsize = 17, color=dz.get_color(0))
  
dz.data_plot(x_regression, y_regression_Garnet92,   'Garnett (1992)', linestyle = ':', color=dz.get_color(1))
dz.data_plot(x_regression, y_regression_EpmDiaz05,  r'$P\'erez$-Montero et al (2005)', linestyle = '--', color=dz.get_color(2))
dz.data_plot(x_regression, y_regression_Epm2014,    r'$P\'erez$-Montero (2014)', linestyle = '-.', color=dz.get_color(3))
...
dz.savefig('/home/vital/Dropbox/Astrophysics/Thesis/images/TOIII_TSIII.jpg')
# dz.display_fig()

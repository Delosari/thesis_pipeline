...
pdf_address_root            = '/home/vital/Dropbox/Astrophysics/Papers/Yp_AlternativeMethods/tables/lines_fluxes_Pdf'
...
for obj_group in [['10', 'MAR1324']]:
    ...
    for i in range(len(redding_laws)):
        ...
        #Start the table
        pdf_address = '/home/vital/Dropbox/Astrophysics/Papers/Yp_AlternativeMethods/tables/lines_fluxes_Pdf' + extensioin_table[i] 
        ...
        for obj in obj_group:
            ...
            cHbeta = catalogue_df.loc[obj, 'cHbeta_{}'.format(redding_laws[i])]
            print cHbeta
            dz.deredden_lines(reduc_linedf, reddening_curve=redding_laws[i], cHbeta=cHbeta, R_v=R_v)
            dz.deredden_lines(emission_linedf, reddening_curve=redding_laws[i], cHbeta=cHbeta, R_v=R_v)
        ...
        for obj in obj_group:
            ...
            cHbeta_emis = catalogue_df.loc[obj, 'cHbeta_{}'.format(redding_laws[i])]

...
for i in range(len(Regresions_dict['Regressions'])):
    ...
    idces_metal     = (catalogue_df['OI_HI_emis2nd'].notnull()) & (catalogue_df['NI_HI_emis2nd'].notnull()) & (catalogue_df['SI_HI_emis2nd'].notnull()) & (catalogue_df['Ymass_S_emis2nd'].notnull()) & (~catalogue_df.index.isin(reject_objs)) & (~catalogue_df.index.isin(['MAR1324']))

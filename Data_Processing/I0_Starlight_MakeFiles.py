...
for i in range(len(catalogue_df.index)):
    ...
    Grid_FileName, Sl_OutputFile, Sl_OutputFolder, X_1Angs, Y_1Angs = dz.GenerateStarlightFiles(ouput_folder, FileName, objName, catalogue_df.iloc[i], Wave_T, spectrum_dered, ext_loop=stellar_files_exten)
